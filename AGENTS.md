...
Целевое устройство первого MVP — OnePlus 11 в SHINECON SC-H12. Основной сценарий
...
Эти правила обязательны. Подробные проектные правила из `.cursor/rules/*.mdc`,
подключённые через `opencode.json`, являются частью этого контракта. Если
