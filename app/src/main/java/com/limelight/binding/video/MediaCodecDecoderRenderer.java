...
//        this.queueInputBufferList = new ArrayList<MediaCodecInputBuffer>();
    ...
    public int setup(int format, int width, int height, int redrawRate) {
        ...
        videoDecoder2 = MoonBridge.createMediaCodec(renderTarget.getSurface(), selectedDecoderName, mimeType, width, height, fps, lowLatency, adaptivePlayback, needsBaselineSpsHack);
        if (videoDecoder2 == 0) {
            return -4;
        }
...
// //        System.out.println("[test] + 提交 " + timestampUs/1000 + " " + (timestampUs-lastTimestampUs)/1000);
...
//                 inputBufferIndex = MoonBridge.dequeueInputBuffer(videoDecoder2);
//                 if (inputBufferIndex < 0) {
//                     // We're being torn down now
//                     return MoonBridge.DR_NEED_IDR;
//                 }
...
//                     return MoonBridge.DR_NEED_IDR;
//                 }
//                 inputBuffer = MoonBridge.getInputBuffer(videoDecoder2, inputBufferIndex);
//                 if (inputBuffer == null) {
//                     // We're being torn down now
//                     return MoonBridge.DR_NEED_IDR;
//                 }
...
//                 if (vpsBuffer != null) {
//                     // buf.put(vpsBuffer);
//                     MoonBridge.nativeCopy(vpsBuffer, 0, inputBuffer, 0, vpsBuffer.limit());
//                     inputBuffer.position(vpsBuffer.limit());
//                 }
//                 if (spsBuffer != null) {
//                     // buf.put(spsBuffer);
//                     MoonBridge.nativeCopy(spsBuffer, 0, inputBuffer, 0, spsBuffer.limit());
//                     inputBuffer.position(spsBuffer.limit());
//                 }
...
//                     //buf.put(ppsBuffer);
//                     MoonBridge.nativeCopy(ppsBuffer, 0, inputBuffer, 0, ppsBuffer.limit());
//                     inputBuffer.position(ppsBuffer.limit());
//                 }
...
//         if (decodeUnitLength > inputBuffer.limit() - inputBuffer.position()) {
