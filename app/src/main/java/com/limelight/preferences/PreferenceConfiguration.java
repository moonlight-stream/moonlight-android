...
public class PreferenceConfiguration {
    ...
    private static final String ONSCREEN_KEYBOARD_MODE_PREF_STRING = "checkbox_osc_keyboard_mode";
    ...
    private static final boolean ONSCREEN_KEYBOARD_MODE_DEFAULT = false;
    ...
    public boolean onscreenKeyboardMode;
    ...
    public static PreferenceConfiguration readPreferences(Context context) {
        ...
        config.onscreenKeyboardMode = prefs.getBoolean(ONSCREEN_KEYBOARD_MODE_PREF_STRING, ONSCREEN_KEYBOARD_MODE_DEFAULT);
