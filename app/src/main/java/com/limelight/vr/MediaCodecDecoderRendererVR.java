...
public class MediaCodecDecoderRendererVR extends EnhancedDecoderRenderer {
    ...
    public MediaCodecDecoderRendererVR(int videoFormat) {
        //dumpDecoders();
    ...
    public boolean setup(VideoDecoderRenderer.VideoFormat format, int width, int height, int redrawRate, Object renderTarget, int drFlags) {
        ...
        videoDecoder.configure(videoFormat, (Surface) renderTarget, null, 0);
    ...
    public class RendererException extends RuntimeException {
        ...
        private final MediaCodecDecoderRendererVR renderer;
        private ByteBuffer currentBuffer;
        private int currentCodecFlags;

        public RendererException(MediaCodecDecoderRendererVR renderer, Exception e) {
            this.renderer = renderer;
            this.originalException = e;
        }

        public RendererException(MediaCodecDecoderRendererVR renderer, Exception e, ByteBuffer currentBuffer, int currentCodecFlags) {
            this.renderer = renderer;
            this.originalException = e;
