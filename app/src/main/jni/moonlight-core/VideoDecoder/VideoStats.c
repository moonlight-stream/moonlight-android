...
int64_t getTimeMsec()
{
    struct timeval t;
    gettimeofday(&t, 0);
    return (int64_t)((int64_t)t.tv_sec * 1000 + t.tv_usec/1000);
//    return getClockMsec();
}
...
int64_t getTimeUsec(void) {
    ...
    struct timeval t;
    gettimeofday(&t, 0);
    return (int64_t)((int64_t)t.tv_sec * 1000*1000 + t.tv_usec);
//    return getClockUsec();
}
...
int64_t getTimeNanc(void) {
    ...
    struct timeval t;
    gettimeofday(&t, 0);
    return (int64_t)((int64_t)t.tv_sec * 1000*1000*1000 + t.tv_usec*1000);
}
